...
add_key_time(254, 255, 250, 1.0, 1.0, 0.07, 0, 0); // 清晨
add_key_time(254, 255, 250, 1.0, 1.0, 0.07, 0, 0); // 清晨

add_key_time(240, 240, 240, 1.0, 1.1, 0.07, 0, 0); // 上午
add_key_time(240, 240, 240, 1.0, 1.1, 0.07, 0, 0); // 上午
add_key_time(240, 240, 240, 1.0, 1.1, 0.07, 0, 0); // 上午
add_key_time(240, 240, 240, 1.0, 1.1, 0.07, 0, 0); // 上午

add_key_time(230, 230, 230, 1.0, 1.1, 0.07, 0, 0); // 中午
add_key_time(230, 230, 230, 1.0, 1.1, 0.07, 0, 0); // 中午

add_key_time(180, 180, 180, 1.0, 1.1, 0.07, 0, 0); // 下午
add_key_time(180, 180, 180, 1.0, 1.1, 0.07, 0, 0); // 下午
add_key_time(180, 180, 180, 1.0, 1.1, 0.07, 0, 0); // 下午
add_key_time(180, 180, 180, 1.0, 1.1, 0.07, 0, 0); // 下午

add_key_time(165, 140, 140, 1.1, 1.1, 0.07, 0, 0); // 傍晚
